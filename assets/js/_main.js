...
// Read the Plotly data from the code block, hide it, and render the chart as new node. The listener
// should only be added if the data is actually present on the page.
//
// NOTE that plotlyLightLayout will be exposed in the minimized file
  ...
  document.addEventListener("readystatechange", function() {
    ...
    script.onload = function() {
      plotlyElements.forEach(function(elem) {
        ...
        // Apply the site's plot template and render it
